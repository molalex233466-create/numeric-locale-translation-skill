...
| EN-RU-002 |     `13,800` | EN number              |              `13 800` | OK     |
| EN-RU-003 |    `250,000` | EN number              |             `250 000` | OK     |
| EN-RU-004 |        `1.5` | EN decimal             |                 `1,5` | OK     |
| EN-RU-005 |      `23.75` | EN decimal             |               `23,75` | OK     |
| EN-RU-006 |   `1,800.50` | EN thousands + decimal |            `1 800,50` | OK     |
| EN-RU-007 | `$23,500.75` | EN currency            |       `23 500,75 USD` | OK     |
...
| CSV-002 | `price,23,500.75` | EN decimal dot, comma delimiter       | parse value as `23500.75` if CSV fields are valid | OK     |
